      ...
      <main className="max-w-6xl mx-auto w-full p-6 space-y-8">
        ...
        <section className="bg-white rounded-xl shadow-sm border border-slate-200 overflow-hidden">
          ...
          <div className="p-8 flex flex-col items-center justify-center border-2 border-dashed border-slate-200 m-6 rounded-xl bg-slate-50/50 hover:bg-white hover:border-blue-300 transition-all group">
            ...
            <p className="text-xs text-slate-400 mt-1 mb-6">支持 JPG, PNG, WEBP, 最大单张 20MB</p>
            
            <div className="flex flex-wrap justify-center gap-4">
              <button 
                onClick={() => document.getElementById('camera-upload')?.click()}
                className="flex items-center gap-2 bg-blue-600 hover:bg-blue-700 text-white px-8 py-3 rounded-full font-bold transition-all shadow-lg active:scale-95"
              >
              ...
              <button 
                ...
                className="flex items-center gap-2 bg-white border border-slate-300 hover:border-slate-800 text-slate-800 px-8 py-3 rounded-full font-bold transition-all shadow-sm active:scale-95"
              >
        ...
        {/* Section 3: Photo Management List */}
        <section className="bg-white rounded-xl shadow-sm border border-slate-200 overflow-hidden">
          <div className="px-6 py-4 border-b border-slate-100 bg-slate-50/50 flex justify-between items-center">
            <h2 className="text-base font-bold text-slate-700">3. 照片管理 ({photos.length})</h2>
            <div className="flex gap-2">
              <button className="text-xs text-blue-600 font-bold hover:underline">全选</button>
              <button className="text-xs text-red-600 font-bold hover:underline">批量删除</button>
            </div>
          </div>
